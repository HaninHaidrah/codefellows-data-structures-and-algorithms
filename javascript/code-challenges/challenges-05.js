...
const addValues = (arr) => {
  // Solution code here...
  const sum=arr.reduce((acummelator,value)=>{
  acummelator=acummelator+value;
  return acummelator;
  },0)
  return sum;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  const pusrshesSum=arr.reduce((acummelator,value)=>{
  acummelator=acummelator+value.purchasePrice
  return acummelator;
  },0)
return pusrshesSum;
};
...
const returnNames = (arr) => {
  // Solution code here...
  const newArray=[]
  arr.reduce((accumelator,value)=>{
    accumelator=value.name
    newArray.push(accumelator)
    return accumelator
  },[])
  return newArray;
};
